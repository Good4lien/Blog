...
# Admin Site Title
ADMIN_HEADLINE = getattr(settings, "GRAPPELLI_ADMIN_HEADLINE", 'Blog')
ADMIN_TITLE = getattr(settings, "GRAPPELLI_ADMIN_TITLE", 'Blog')

# Link to your Main Admin Site (no slashes at start and end)
# not needed anymore
ADMIN_URL = getattr(settings, "GRAPPELLI_ADMIN_URL", '/adm44/')
